...
public class JmsDestinationType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.javaee.String resourceAdapter;
    @XmlElement(name = "destination-name")
    protected za.co.enigma.turing.mda.jee.xsd.javaee.String destinationName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.javaee.String getResourceAdapter() {
     ...
     *     
     */
    public void setResourceAdapter(za.co.enigma.turing.mda.jee.xsd.javaee.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.javaee.String getDestinationName() {
     ...
     *     
     */
    public void setDestinationName(za.co.enigma.turing.mda.jee.xsd.javaee.String value) {
