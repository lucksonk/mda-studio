...
public class MailSessionType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.connector.String storeProtocol;
    ...
    protected za.co.enigma.turing.mda.jee.xsd.connector.String transportProtocol;
    @XmlElement(name = "transport-protocol-class")
    protected FullyQualifiedClassType transportProtocolClass;
    protected za.co.enigma.turing.mda.jee.xsd.connector.String host;
    ...
    protected za.co.enigma.turing.mda.jee.xsd.connector.String from;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.connector.String getStoreProtocol() {
     ...
     *     
     */
    public void setStoreProtocol(za.co.enigma.turing.mda.jee.xsd.connector.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.connector.String getTransportProtocol() {
     ...
     *     
     */
    public void setTransportProtocol(za.co.enigma.turing.mda.jee.xsd.connector.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.connector.String getHost() {
        return host;
    }
     ...
     *     
     */
    public void setHost(za.co.enigma.turing.mda.jee.xsd.connector.String value) {
        this.host = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.connector.String getFrom() {
        return from;
    }
     ...
     *     
     */
    public void setFrom(za.co.enigma.turing.mda.jee.xsd.connector.String value) {
        this.from = value;
    }
