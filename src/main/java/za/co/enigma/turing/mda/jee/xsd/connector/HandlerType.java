...
public class HandlerType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.connector.String handlerName;
    ...
    protected List<za.co.enigma.turing.mda.jee.xsd.connector.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<za.co.enigma.turing.mda.jee.xsd.connector.String> portName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.connector.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(za.co.enigma.turing.mda.jee.xsd.connector.String value) {
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.connector.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<za.co.enigma.turing.mda.jee.xsd.connector.String>();
        }
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.connector.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<za.co.enigma.turing.mda.jee.xsd.connector.String>();
        }
