...
public class JmsConnectionFactoryType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String resourceAdapter;
    ...
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String clientId;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getResourceAdapter() {
     ...
     *     
     */
    public void setResourceAdapter(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getClientId() {
        return clientId;
    }
     ...
     *     
     */
    public void setClientId(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
        this.clientId = value;
    }
