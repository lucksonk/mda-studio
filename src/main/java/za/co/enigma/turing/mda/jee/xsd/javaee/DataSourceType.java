...
public class DataSourceType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.javaee.String serverName;
    @XmlElement(name = "port-number")
    protected XsdIntegerType portNumber;
    @XmlElement(name = "database-name")
    protected za.co.enigma.turing.mda.jee.xsd.javaee.String databaseName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.javaee.String getServerName() {
        return serverName;
    }
     ...
     *     
     */
    public void setServerName(za.co.enigma.turing.mda.jee.xsd.javaee.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.javaee.String getDatabaseName() {
        return databaseName;
    }
     ...
     *     
     */
    public void setDatabaseName(za.co.enigma.turing.mda.jee.xsd.javaee.String value) {
