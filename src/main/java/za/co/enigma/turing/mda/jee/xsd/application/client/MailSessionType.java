...
public class MailSessionType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String storeProtocol;
    ...
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String transportProtocol;
    @XmlElement(name = "transport-protocol-class")
    protected FullyQualifiedClassType transportProtocolClass;
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String host;
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String user;
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String password;
    protected za.co.enigma.turing.mda.jee.xsd.application.client.String from;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getStoreProtocol() {
     ...
     *     
     */
    public void setStoreProtocol(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getTransportProtocol() {
     ...
     *     
     */
    public void setTransportProtocol(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getHost() {
        return host;
    }
     ...
     *     
     */
    public void setHost(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
        this.host = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getUser() {
        return user;
    }
     ...
     *     
     */
    public void setUser(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
        this.user = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getPassword() {
        return password;
    }
     ...
     *     
     */
    public void setPassword(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
        this.password = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.client.String getFrom() {
        return from;
    }
     ...
     *     
     */
    public void setFrom(za.co.enigma.turing.mda.jee.xsd.application.client.String value) {
        this.from = value;
    }
