...
public class HandlerType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.permissions.String handlerName;
    ...
    protected List<za.co.enigma.turing.mda.jee.xsd.permissions.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<za.co.enigma.turing.mda.jee.xsd.permissions.String> portName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.permissions.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(za.co.enigma.turing.mda.jee.xsd.permissions.String value) {
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.permissions.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<za.co.enigma.turing.mda.jee.xsd.permissions.String>();
        }
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.permissions.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<za.co.enigma.turing.mda.jee.xsd.permissions.String>();
        }
