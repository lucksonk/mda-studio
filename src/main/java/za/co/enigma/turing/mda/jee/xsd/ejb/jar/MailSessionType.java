...
public class MailSessionType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.ejb.jar.String storeProtocol;
    ...
    protected za.co.enigma.turing.mda.jee.xsd.ejb.jar.String transportProtocol;
    @XmlElement(name = "transport-protocol-class")
    protected FullyQualifiedClassType transportProtocolClass;
    protected za.co.enigma.turing.mda.jee.xsd.ejb.jar.String host;
    protected za.co.enigma.turing.mda.jee.xsd.ejb.jar.String user;
    protected za.co.enigma.turing.mda.jee.xsd.ejb.jar.String password;
    protected za.co.enigma.turing.mda.jee.xsd.ejb.jar.String from;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.ejb.jar.String getStoreProtocol() {
     ...
     *     
     */
    public void setStoreProtocol(za.co.enigma.turing.mda.jee.xsd.ejb.jar.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.ejb.jar.String getTransportProtocol() {
     ...
     *     
     */
    public void setTransportProtocol(za.co.enigma.turing.mda.jee.xsd.ejb.jar.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.ejb.jar.String getHost() {
        return host;
    }
     ...
     *     
     */
    public void setHost(za.co.enigma.turing.mda.jee.xsd.ejb.jar.String value) {
        this.host = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.ejb.jar.String getUser() {
        return user;
    }
     ...
     *     
     */
    public void setUser(za.co.enigma.turing.mda.jee.xsd.ejb.jar.String value) {
        this.user = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.ejb.jar.String getPassword() {
        return password;
    }
     ...
     *     
     */
    public void setPassword(za.co.enigma.turing.mda.jee.xsd.ejb.jar.String value) {
        this.password = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.ejb.jar.String getFrom() {
        return from;
    }
     ...
     *     
     */
    public void setFrom(za.co.enigma.turing.mda.jee.xsd.ejb.jar.String value) {
        this.from = value;
    }
