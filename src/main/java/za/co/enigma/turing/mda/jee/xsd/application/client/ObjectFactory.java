 ...
 * generated in the za.co.enigma.turing.mda.jee.xsd.application.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _ApplicationClient_QNAME = new QName("http://xmlns.jcp.org/xml/ns/javaee", "application-client");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: za.co.enigma.turing.mda.jee.xsd.application.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.jcp.org/xml/ns/javaee", name = "application-client")
