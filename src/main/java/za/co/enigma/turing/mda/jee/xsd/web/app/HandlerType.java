...
public class HandlerType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.web.app.String handlerName;
    ...
    protected List<za.co.enigma.turing.mda.jee.xsd.web.app.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<za.co.enigma.turing.mda.jee.xsd.web.app.String> portName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.web.app.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(za.co.enigma.turing.mda.jee.xsd.web.app.String value) {
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.web.app.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<za.co.enigma.turing.mda.jee.xsd.web.app.String>();
        }
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.web.app.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<za.co.enigma.turing.mda.jee.xsd.web.app.String>();
        }
