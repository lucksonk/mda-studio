...
public class HandlerType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.javaee.String handlerName;
    ...
    protected List<za.co.enigma.turing.mda.jee.xsd.javaee.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<za.co.enigma.turing.mda.jee.xsd.javaee.String> portName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.javaee.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(za.co.enigma.turing.mda.jee.xsd.javaee.String value) {
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.javaee.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<za.co.enigma.turing.mda.jee.xsd.javaee.String>();
        }
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.javaee.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<za.co.enigma.turing.mda.jee.xsd.javaee.String>();
        }
