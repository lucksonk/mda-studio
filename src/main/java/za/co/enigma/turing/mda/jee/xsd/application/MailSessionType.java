...
public class MailSessionType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.application.String storeProtocol;
    ...
    protected za.co.enigma.turing.mda.jee.xsd.application.String transportProtocol;
    @XmlElement(name = "transport-protocol-class")
    protected FullyQualifiedClassType transportProtocolClass;
    protected za.co.enigma.turing.mda.jee.xsd.application.String host;
    protected za.co.enigma.turing.mda.jee.xsd.application.String user;
    protected za.co.enigma.turing.mda.jee.xsd.application.String password;
    protected za.co.enigma.turing.mda.jee.xsd.application.String from;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.String getStoreProtocol() {
     ...
     *     
     */
    public void setStoreProtocol(za.co.enigma.turing.mda.jee.xsd.application.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.String getTransportProtocol() {
     ...
     *     
     */
    public void setTransportProtocol(za.co.enigma.turing.mda.jee.xsd.application.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.String getHost() {
        return host;
    }
     ...
     *     
     */
    public void setHost(za.co.enigma.turing.mda.jee.xsd.application.String value) {
        this.host = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.String getUser() {
        return user;
    }
     ...
     *     
     */
    public void setUser(za.co.enigma.turing.mda.jee.xsd.application.String value) {
        this.user = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.String getPassword() {
        return password;
    }
     ...
     *     
     */
    public void setPassword(za.co.enigma.turing.mda.jee.xsd.application.String value) {
        this.password = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.String getFrom() {
        return from;
    }
     ...
     *     
     */
    public void setFrom(za.co.enigma.turing.mda.jee.xsd.application.String value) {
        this.from = value;
    }
