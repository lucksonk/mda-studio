...
public class JmsDestinationType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.connector.String resourceAdapter;
    @XmlElement(name = "destination-name")
    protected za.co.enigma.turing.mda.jee.xsd.connector.String destinationName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.connector.String getResourceAdapter() {
     ...
     *     
     */
    public void setResourceAdapter(za.co.enigma.turing.mda.jee.xsd.connector.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.connector.String getDestinationName() {
     ...
     *     
     */
    public void setDestinationName(za.co.enigma.turing.mda.jee.xsd.connector.String value) {
