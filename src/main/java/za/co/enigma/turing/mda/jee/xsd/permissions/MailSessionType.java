...
public class MailSessionType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.permissions.String storeProtocol;
    ...
    protected za.co.enigma.turing.mda.jee.xsd.permissions.String transportProtocol;
    @XmlElement(name = "transport-protocol-class")
    protected FullyQualifiedClassType transportProtocolClass;
    protected za.co.enigma.turing.mda.jee.xsd.permissions.String host;
    protected za.co.enigma.turing.mda.jee.xsd.permissions.String user;
    protected za.co.enigma.turing.mda.jee.xsd.permissions.String password;
    protected za.co.enigma.turing.mda.jee.xsd.permissions.String from;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.permissions.String getStoreProtocol() {
     ...
     *     
     */
    public void setStoreProtocol(za.co.enigma.turing.mda.jee.xsd.permissions.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.permissions.String getTransportProtocol() {
     ...
     *     
     */
    public void setTransportProtocol(za.co.enigma.turing.mda.jee.xsd.permissions.String value) {
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.permissions.String getHost() {
        return host;
    }
     ...
     *     
     */
    public void setHost(za.co.enigma.turing.mda.jee.xsd.permissions.String value) {
        this.host = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.permissions.String getUser() {
        return user;
    }
     ...
     *     
     */
    public void setUser(za.co.enigma.turing.mda.jee.xsd.permissions.String value) {
        this.user = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.permissions.String getPassword() {
        return password;
    }
     ...
     *     
     */
    public void setPassword(za.co.enigma.turing.mda.jee.xsd.permissions.String value) {
        this.password = value;
    }
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.permissions.String getFrom() {
        return from;
    }
     ...
     *     
     */
    public void setFrom(za.co.enigma.turing.mda.jee.xsd.permissions.String value) {
        this.from = value;
    }
