...
public class HandlerType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.ejb.jar.String handlerName;
    ...
    protected List<za.co.enigma.turing.mda.jee.xsd.ejb.jar.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<za.co.enigma.turing.mda.jee.xsd.ejb.jar.String> portName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.ejb.jar.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(za.co.enigma.turing.mda.jee.xsd.ejb.jar.String value) {
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.ejb.jar.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<za.co.enigma.turing.mda.jee.xsd.ejb.jar.String>();
        }
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.ejb.jar.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<za.co.enigma.turing.mda.jee.xsd.ejb.jar.String>();
        }
