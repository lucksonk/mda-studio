...
public class HandlerType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.application.String handlerName;
    ...
    protected List<za.co.enigma.turing.mda.jee.xsd.application.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<za.co.enigma.turing.mda.jee.xsd.application.String> portName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.application.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(za.co.enigma.turing.mda.jee.xsd.application.String value) {
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.application.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<za.co.enigma.turing.mda.jee.xsd.application.String>();
        }
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.application.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<za.co.enigma.turing.mda.jee.xsd.application.String>();
        }
