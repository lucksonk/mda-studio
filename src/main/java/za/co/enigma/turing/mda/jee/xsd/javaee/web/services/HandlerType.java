...
public class HandlerType {
    ...
    protected za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String handlerName;
    ...
    protected List<za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String> portName;
     ...
     *     
     */
    public za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String value) {
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String>();
        }
     ...
     * 
     */
    public List<za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<za.co.enigma.turing.mda.jee.xsd.javaee.web.services.String>();
        }
